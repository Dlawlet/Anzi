    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <svg className="w-16 h-16 mb-4 ml-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              Once you&apos;ve submitted your request, our dedicated team swings into action. Here&apos;s how the verification process unfolds:
                ...
                <br/>
                <b>Accuracy Assurance</b>:  We ensure that the information matches reality.
                <br/>
                <b>Trust Boost</b>: Verified addresses instill confidence in your presence.
              </p>
            </div>
            ...
            <svg className="w-16 h-16 mb-4 ml-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <h4 className="h4 mb-2">Your Verified Address</h4>
              <p className="text-lg text-gray-400 text-justify">
                When your address is verified, you unlock a world of benefits:
                <br/>
                <b>Credibility</b>:  Establish trust with businesses and administrative bodies.
                <br/>
          ...
          <h4 className="h4 mb-2 mt-10 text-center"> Ready to Begin?</h4>
                      <p className="text-lg text-gray-400 text-center mb-2">
                      Fill out the form below to request address verification. Your journey toward a verified address starts here. Thank you for choosing Anzi Network.
                      </p>
        </div>
      </div>
    </section>
