      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Join the Movement, Inspire Change</h2>
            <p className="text-xl text-gray-400">We understand that change can be daunting, especially when it comes to embracing new systems. But together, we can create a future where every individual has the power of an address. By taking the initiative today, you inspire others to follow suit, driving progress for your community and beyond.</p>
          </div>
